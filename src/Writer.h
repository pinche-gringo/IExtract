...
class Writer : public YGP::TableWriter {
  public:
    Writer(const std::string& format, const std::string& New, unsigned long age = 0, const char* startRow = "",
           const char* endRow = "", const char* sepColumn = " ", const char* startTab = "", const char* endTab = "",
           const char* sepTab = " ", const char* rowStartHdr = nullptr, const char* rowEndHdr = nullptr,
    ...
    void printSeparator(std::ostream& out, const YGP::File& file, const std::string& data, const std::string& title) const;
...
class TextWriter : public Writer {
  public:
    ...
    static std::unique_ptr<Writer> create(const std::string& format, const std::string& strNew, unsigned long age = 0) {
...
class XMLWriter : public HTMLWriter {
  public:
    XMLWriter(const std::string& format, const std::string& strNew, unsigned long age = 0) : HTMLWriter(format, strNew, age) {}
